                                                                    ...
                                                                    fluidRow(column(3,
                                                                                    radioButtons('subset_bar',
                                                                                                 ...
                                                                                                 choices = c('% of subset',
                                                                                                             '% of whole'))),
                                                                             column(9,
                                                                                    plotlyOutput('barChart') %>% withSpinner(color = '#669e34', hide.ui = F))))),
                                                       tabPanel('Pie Chart',
                                                                div(style = 'overflow-y:scroll;height:500px;',
                                                                    fluidRow(column(3,
                                                                                    radioButtons('subset_pie',
                                                                                                 ...
                                                                                                 choices = c('% of subset',
                                                                                                             '% of whole'))),
                                                                             column(9,
                                                                                    plotlyOutput('doughnutChart') %>% withSpinner(color = '#669e34'))))))),
                                                ...
                                                tabBox(width = 12,
                                                       ...
                                                       tabPanel("Classifications",
                                                                div(style = 'overflow-y:scroll;height:600px;',
                                                                    dataTableOutput('classification_dataset') %>% withSpinner(color = '#669e34'),
                                                                    downloadButton('download_classification_cols', 'Download'))),
                                                       tabPanel('Intensities',
                                                                div(style = 'overflow-y:scroll;height:600px;',
                                                                    dataTableOutput('intensity_dataset') %>% withSpinner(color = '#669e34'),
                                                       ...
                                                       tabPanel('Double Positives',
                                                                div(style = 'overflow-y:scroll;height:625px;',
                                                                    ...
                                                                    dataTableOutput('double_positive_data') %>% withSpinner(color = '#669e34'),
                                                                    downloadButton('download_dp_total', 'Download'),
                                                                    br(),
                                                                    br(),
                                                                    h3("Double Positive % (whole tissue)"),
                                                                    dataTableOutput('double_positive_percentages') %>% withSpinner(color = '#669e34'),
                                                                    downloadButton('download_dp_perc', 'Download'))),
                                                       tabPanel('Full Dataset',
                                                                div(style = 'overflow-y:scroll;height:600px;',
                                                                    dataTableOutput('full_dataset') %>% withSpinner(color = '#669e34'))))),
                                                ...
                                                fluidRow(column(2,
                                                                selectizeInput('y_input',
                                                                               ...
                                                                               options = list(
                                                                                   ...
                                                                                   onInitialize = I('function() { this.setValue(""); }')))),
                                                         column(10,
                                                                plotlyOutput('intensityChart') %>% withSpinner(color = '#669e34'))),
                                                fluidRow(column(2),
                                                         column(10,
                                                ...
                                                tabBox(width = 12,
                                                       tabPanel('Two Markers',
                                                                div(style = 'overflow-y:scroll;height:730px;',
                                                                    ...
                                                                    fillPage(plotlyOutput("cellMap", height="100%", width="100%") %>% withSpinner(color = '#669e34')))),
                                                       tabPanel('One Marker',
                                                                div(style = 'overflow-y:scroll;height:730px;',
                                                                    fluidRow(column(12,
                                                                    ...
                                                                    fillPage(plotlyOutput("cellMap_ind", height="100%", width="100%") %>% withSpinner(color = '#669e34')))))
                                        ),
